...
from my_cogs import linkutils, utils
...
class Music(commands.Cog):
    ...
    @commands.command(name='skip', description=config.HELP_SKIP_LONG, help=config.HELP_SKIP_SHORT, aliases=['s' , "fs" , "forceskip"])
    ...
    @commands.command(name='songinfo', description=config.HELP_SONGINFO_LONG, help=config.HELP_SONGINFO_SHORT, aliases=["np", "now"])
