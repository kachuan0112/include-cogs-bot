...
BOT_TOKEN: str = "ODY1NDU0NzExMjMzNzA4MDMz.YPEPgg.zTFsC2zsKTZCxjCHqvdXrpJaBMs"
SPOTIFY_ID: str = ""
SPOTIFY_SECRET: str = ""

BOT_PREFIX = "="

EMBED_COLOR = discord.Color.blurple()  #replace after'0x' with desired hex code ex. '#ff0188' >> '0xff0188'

SUPPORTED_EXTENSIONS = ('.webm', '.mp4', '.mp3', '.avi', '.wav', '.m4v', '.ogg', '.mov')

MAX_SONG_PRELOAD = 50  #maximum of 25

COOKIE_PATH = "/config/cookies/cookies.txt"

GLOBAL_DISABLE_AUTOJOIN_VC = False

VC_TIMEOUT = 7200 #seconds
...
NO_TOKEN_COMMAND = "Error: No bot token!"
